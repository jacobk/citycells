...
| Scrollable Mini-Map with Maximize | [map-visualization.md](./map-visualization.md) | Planned | [ADR 022](../ADR/022-scrollable-minimap-with-maximize.md), [ADR 021](../ADR/021-tiered-distance-scoring.md) |
